...
public:
    ...
    double getDistance(const Position &other) const {
        const auto lat1 = degreesToRadians(_lat);
        const auto lon1 = degreesToRadians(_lon);
        const auto lat2 = degreesToRadians(other._lat);
        const auto lon2 = degreesToRadians(other._lon);
